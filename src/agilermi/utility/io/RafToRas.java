 ...
 *
 */
class RafToRas implements RandomAccessService {

	private RandomAccessFile raf;

	/**
	 * Adapts a {@link RandomAccessFile} instance to be remote
	 * 
	 * @param randomAccessFile the instance to adapt
	 */
	RafToRas(RandomAccessFile randomAccessFile) {
		this.raf = randomAccessFile;
	}

	/**
	 * Creates a {@link RandomAccessFile} instance adapted to be remote
	 * 
	 * @param file the file to access
	 * @param mode the access mode (as in {@link RandomAccessFile})
	 * @throws FileNotFoundException if the file cannot be found
	 */
	public RafToRas(File file, String mode) throws FileNotFoundException {
	 ...
	 * @throws FileNotFoundException if the file cannot be found
	 */
	public RafToRas(String name, String mode) throws FileNotFoundException {
