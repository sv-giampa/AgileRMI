...
public class ObjectPeer {
	 ...
	 * {@link ObjectPeer} object will not function properly. A call to this method
	 * cause a callback on the failure observers attached to the registry sending
	 * them an instance of {@link PeerDispositionException}
	 */
	public synchronized void dispose() {
		...
		for (StubInvocation invocation : invocations.values())
			forceInvocationReturn(invocation);

		PeerDispositionException dispositionException = new PeerDispositionException();
